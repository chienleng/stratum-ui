...
import { aggregateByBoundary, aggregateForDisplay, aggregateToInterval } from './aggregation.js';
 ...
 */
function fiveMinRows(startMs: number, n: number, v = 1) {
 ...
 */
function monthRow(year: number, month0: number, v: number, offsetHours = NEM) {
