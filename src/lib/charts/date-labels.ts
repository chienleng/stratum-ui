 ...
 * share the key.
 *
 * @param key - Stable name for the option set
 */
 ...
 */
export function formatDayMonth(d: Date | number | unknown, ianaTimeZone: string): string {
	const date = toDate(d);
 ...
 */
export function formatDayMonthYear(d: Date | number | unknown, ianaTimeZone: string): string {
	const date = toDate(d);
	if (!date) return '';
 ...
 */
export function formatDayMonthYearTime(d: Date | number | unknown, ianaTimeZone: string): string {
	const date = toDate(d);
	if (!date) return '';
 ...
 * "Jun 2025".
 */
export function formatMonthYear(d: Date | number | unknown, ianaTimeZone: string): string {
	const date = toDate(d);
	if (!date) return '';
 ...
 * "2025".
 */
export function formatYear(d: Date | number | unknown, ianaTimeZone: string): string {
	const date = toDate(d);
	if (!date) return '';
 ...
 */
export function localYearMonth(date: Date, ianaTimeZone: string): { year: number; month0: number } {
...
export function formatDateRange(
	...
	{
		alwaysYear = false,
		yearIfNotCurrent = false
	}: { alwaysYear?: boolean; yearIfNotCurrent?: boolean } = {}
): string {
