<script lang="ts">
	/**
	 * bits-ui-backed port of `ui/options-menu/OptionsMenuHeading.svelte`.
	 * Identical props and visuals; intentionally stays a presentational div
...
<div class="su-options-menu-heading">
	{#if Icon}
		<Icon class="mh-icon" />
	{:else}
...
<style>
	.su-options-menu-heading {
		...
		letter-spacing: var(--su-tracking-wider, 0.045em);
	}

	.su-options-menu-heading :global(.mh-icon),
	.icon-spacer {
		width: 10px;
		height: 10px;
		flex-shrink: 0;
