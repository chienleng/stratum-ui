...
<script lang="ts">
	/**
	 * bits-ui-backed port of `forms/MultiSelect.svelte` — multi-select dropdown
	 * with checkbox-style option indicators. Identical props and visuals;
	 * open/close, outside-click, Escape, keyboard navigation and typeahead are
	 * now delegated to bits-ui Select (type="multiple"). Clicking an option
	 * toggles it; meta/alt-clicking selects only that option. With
