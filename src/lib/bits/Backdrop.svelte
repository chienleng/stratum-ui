<script lang="ts">
	...
	/**
	 * Full-page modal backdrop — bits-ui-backed port of ui/Backdrop.svelte.
	 * A plain dimming surface gains nothing from a headless dialog, so this is
	 * a thin port: the only bits-ui primitive used is Portal (replacing the
	 * in-house portal action), which moves the backdrop to <body> so it always
