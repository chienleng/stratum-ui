<script lang="ts">
	/**
	 * bits-ui-backed port of `forms/Checkbox`. Same props and visuals; the
	 * hidden native input is replaced by a visually-hidden Checkbox.Root button
	 * (keyboard/ARIA via bits-ui) and `name` renders a hidden input for form
	 * submission.
	 */
