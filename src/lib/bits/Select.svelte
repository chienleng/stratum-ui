...
<script lang="ts">
	/**
	 * bits-ui-backed port of `forms/Select.svelte` — single-select dropdown with
	 * radio-style option indicators. Identical props and visuals; open/close,
	 * outside-click, Escape, keyboard navigation and typeahead are now delegated
	 * to bits-ui Select. With `staticDisplay` the options render inline instead
	 * of in a portal.
	 */
