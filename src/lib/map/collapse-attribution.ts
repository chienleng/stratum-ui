/** The slice of the MapLibre map instance this helper needs — structural, so no maplibre-gl import. */
 ...
 *
 * @returns cleanup that disconnects the observer and removes the listener
 */
export function collapseMapAttribution(map: AttributionMapLike): () => void {
